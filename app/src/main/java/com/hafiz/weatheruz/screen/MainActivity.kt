...
import com.hafiz.weatheruz.Constants.APP_ID
import com.hafiz.weatheruz.Constants.PERMISSON_REQUEST_ACCES_LOCATION
import com.hafiz.weatheruz.R
import com.hafiz.weatheruz.databinding.ActivityMainBinding
...
import com.hafiz.weatheruz.view.DaylyAdapterListener
import com.hafiz.weatheruz.view.DaylyWeatherAdapter
import com.hafiz.weatheruz.view.HourlyAdapterListener
import com.hafiz.weatheruz.view.HourlyWeatherAdapter
import com.hafiz.weatheruz.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    fun updateUI(id: Int) {
        if (id in 200..232) {
            ...
            binding.fatherLayout.background =
                    ContextCompat.getDrawable(this, com.hafiz.weatheruz.R.drawable.drizzle)
            ...
            if (viewModel.currentWeatherData.value?.weather?.get(0)?.icon?.subSequence(
                    2,
                    3
                ) == "n"
            ) {
                ...
                binding.fatherLayout.background =
                        ContextCompat.getDrawable(this, R.drawable.day_sky)
            }
        } else if (id == 801) {
            if (viewModel.currentWeatherData.value?.weather?.get(0)?.icon?.subSequence(
                    2,
                ...
                binding.fatherLayout.background =
                        ContextCompat.getDrawable(this, R.drawable.cloudy_sky_one)
            }
        } else if (id == 802) {
            if (viewModel.currentWeatherData.value?.weather?.get(0)?.icon?.subSequence(
                    2,
                ...
                binding.fatherLayout.background =
                        ContextCompat.getDrawable(this, R.drawable.cloudy_sky_two)
            }
    ...
    fun hideKeyboard() {
        ...
        imm.hideSoftInputFromWindow(ed_search_city.windowToken, 0)
    }
